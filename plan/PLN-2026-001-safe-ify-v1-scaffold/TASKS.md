...
|---|-------|------|------|-------|-------------|--------|----|--------|
| T1 | S1 | Implement project scaffold + global config | Implementer | Sonnet | 03-arch, 04-config, 05-ops | go.mod, Makefile, cmd/, internal/config/, internal/cli/root.go | AC1: `go build ./...` succeeds; AC2: global config loads/saves with 0600 | Pending |
